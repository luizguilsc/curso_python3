...
class Log(ABC): #é necessario herdar de ABC
    @abstractmethod
    def _log(self, msg):...
        # raise NotImplementedError('Implemente o método log') #não preciso pois é ab
...
class LogPrintMixin(Log):
    def _log(self, msg): # implementação do metodo abstrato, devo manter a mesma assinatura do metodo abstrato
